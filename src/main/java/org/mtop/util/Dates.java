...
public class Dates {
     ...
     * for instance milliseconds or days. </p>
     *
     *
     *
    ...
    private static class DateUtils {
         ...
         * <li>March 30, 2003 02:40 rounds to March 30, 2003 04:00</li> </ul>
         * </p>
         *
         ...
         * be split in milliseconds)</li> </ul> </p>
         *
         ...
         * deprecated date.getMinutes())</li> <li>January 1, 2008 7:15:10.538
         * with Calendar.MONTH as fragment will return 15</li> <li>January 6,
         * 2008 7:15:10.538 with Calendar.MONTH as fragment will return 435
         * (7*60 + 15)</li> <li>January 16, 2008 7:15:10.538 with
         * Calendar.MILLISECOND as fragment will return 0 (a millisecond cannot
         * be split in minutes)</li> </ul> </p>
         *
         * @param date the date to work with, not null
         * @param fragment the Calendar field part of date to calculate
         ...
         * deprecated date.getHours())</li> <li>January 1, 2008 7:15:10.538 with
         * Calendar.MONTH as fragment will return 7</li> <li>January 6, 2008
         * 7:15:10.538 with Calendar.MONTH as fragment will return 127 (5*24 +
         * 7)</li> <li>January 16, 2008 7:15:10.538 with Calendar.MILLISECOND as
         ...
         * millisecond cannot be split in days)</li> </ul> </p>
         *
         * @param date the date to work with, not null
         * @param fragment the Calendar field part of date to calculate
         ...
         * 6, 2008 7:15:10.538 with Calendar.MINUTE as fragment will return
         * 10538 (10*1000 + 538)</li> <li>January 16, 2008 7:15:10.538 with
         * Calendar.MILLISECOND as fragment will return 0 (a millisecond cannot
         * be split in milliseconds)</li> </ul> </p>
         *
         ...
         * calendar.get(Calendar.MINUTES))</li> <li>January 1, 2008 7:15:10.538
         * with Calendar.MONTH as fragment will return 15</li> <li>January 6,
         * 2008 7:15:10.538 with Calendar.MONTH as fragment will return 435
         * (7*60 + 15)</li> <li>January 16, 2008 7:15:10.538 with
         * Calendar.MILLISECOND as fragment will return 0 (a millisecond cannot
         ...
         * (equivalent to calendar.get(Calendar.HOUR_OF_DAY))</li> <li>January
         * 1, 2008 7:15:10.538 with Calendar.MONTH as fragment will return
         * 7</li> <li>January 6, 2008 7:15:10.538 with Calendar.MONTH as
         * fragment will return 127 (5*24 + 7)</li> <li>January 16, 2008
         * 7:15:10.538 with Calendar.MILLISECOND as fragment will return 0 (a
         * millisecond cannot be split in hours)</li> </ul> </p>
         *
         * @param calendar the calendar to work with, not null
         * @param fragment the Calendar field part of calendar to calculate
         * @return number of hours within the fragment of date
         ...
         * calendar.get(Calendar.DAY_OF_YEAR))</li> <li>February 28, 2008 with
         * Calendar.YEAR as fragment will return 59 (equivalent to
         * calendar.get(Calendar.DAY_OF_YEAR))</li> <li>January 28, 2008 with
         * Calendar.MILLISECOND as fragment will return 0 (a millisecond cannot
         * be split in days)</li> </ul> </p>
         *
         * @param calendar the calendar to work with, not null
         * @param fragment the Calendar field part of calendar to calculate
         * @return number of days within the fragment of date
