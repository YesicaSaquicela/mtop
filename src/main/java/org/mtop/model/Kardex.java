...
public class Kardex extends EntidadGeneral implements Serializable {

   
    @Temporal(javax.persistence.TemporalType.DATE)
    private Date fechaEntradaR;
    @Temporal(javax.persistence.TemporalType.DATE)
    private Date fechaSalidaR;
    private String observaciones;
    @OneToMany(mappedBy = "kardex", cascade = CascadeType.ALL, fetch = FetchType.LAZY)
    private List<SolicitudReparacion> listaSolicitudReparacion = new ArrayList<SolicitudReparacion>();
    @OneToMany(mappedBy = "kardex",cascade = CascadeType.ALL,fetch = FetchType.LAZY)
    ...
    public List<SolicitudReparacion> getListaSolicitudReparacion() {
        return listaSolicitudReparacion;
    }

    public void setListaSolicitudReparacion(List<SolicitudReparacion> listaSolicitudReparacion) {
        for (SolicitudReparacion solicitudReparacion : listaSolicitudReparacion) {
