...
@RequestScoped
@FacesValidator("verificarPlaca")
public class verificarPlaca implements Validator
{
   @Inject
            ...
            throws ValidatorException
   {
      if (value instanceof String && !value.equals(vehiculo.getPlaca())) {
         ...
         if (!cv.verificarPlaca((String) value))
            throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, "La placa ingresada es incorrecta.", null));
      }
   }
}